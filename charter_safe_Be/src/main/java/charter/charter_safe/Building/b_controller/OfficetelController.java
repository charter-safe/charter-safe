...
public class OfficetelController {
    ...
    public ApiResponse<?> saveOfficetelData() throws Exception{
        ...
        List<CharterDto> charterList = new ArrayList<>();
        ...
        for(String lawd_cd : LAWD_CD) {
            ...
            List<CharterDto> currentRentList = charterApiService.CharterInfoApiParseXml(jsonData1);
            List<TradeDto> currentTradeList = tradeApiService.TradeInfoApiParseXml(jsonData2);
